...
//                @GridCell(x = 0, y = 24, component = BasicAreaChart.class),
//                @GridCell(x = 6, y = 24, component = BasicAreaChart.class),
//                @GridCell(x = 0, y = 32, component = BasicAreaChart.class),
//                @GridCell(x = 6, y = 32, component = BasicAreaChart.class),
        }
)
